...
export function OrbGlow({
  ...
  const layer1Final = useDerivedValue(() => layer1Opacity.value * 0.3 * opacityMultiplierSv.value);
  const layer2Final = useDerivedValue(() => layer2Opacity.value * 0.4 * opacityMultiplierSv.value);
  const layer3Final = useDerivedValue(() => layer3Opacity.value * 0.5 * opacityMultiplierSv.value);
